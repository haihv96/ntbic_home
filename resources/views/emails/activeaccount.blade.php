...
<p style="color:black; font-size: 18px; ">Xin chào {{$name}} !</p>
...
<p style="color:black; font-size: 18px; color: blue">Tên tài khoản: {{$username}}</p>
<p style="color:black; font-size: 18px; color: blue">Email đăng ký: {{$email}}</p>
<p style="color:black; font-size: 18px; color: blue">Mật khẩu: {{$pass}}</p>
<p style="color:black; font-size: 18px; ">Truy cập kích hoạt tài khoản tại {{$link_active}} </p>
