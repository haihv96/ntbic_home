...
<div class="col-md-8">
	<div class="address-company">
		...
		<div class="col-md-7">
			<p><i class="fa fa-home" aria-hidden="true"> Địa chỉ: 25 Lê Thánh Tông, Quận Hoàn Kiếm, Hà Nội</i></p>
			<p><i class="fa fa-phone-square" aria-hidden="true"> Số điện thoại: (04) 3933 6570 </i></p>
		...
		<div class="col-md-5">
            ...
            <p><i class="fa fa-skype" aria-hidden="true"> Skype: <a herf>skype..</a></i></p>
            <p><i class="fa fa-google-plus-square" aria-hidden="true"> Google: <a herf>google..</a></i></p> 	
		</div>
