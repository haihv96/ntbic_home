    	...
    	<div class="header-news">
    		<div class="row">
	    		<h3 class="title-detail-news">
		    		Chương trình giao lưu kỷ niệm Năm đoàn kết hữu nghị Lào 2017
		    	</h3>
	    	</div>
	    	<div class="row">
		    	<div class="date-detail-news">
		    		<span>Thứ ba, 20/06/2017 | 07:55 GMT+7</span>
		    	</div>
	    	</div>
	    	<div class="row">
    	...
    	<div class="row">
    		<div class="row list-other-news">	    		
				<div class="col-md-3 ">
				    <div class="thumbnail ">
				      <a href="#">
				        <img src="pages/image/fjords.jpg" alt="Lights" style="width:100%">
				        <div class="caption">
				          <p>Lorem ipsum...</p>
				        </div>
				      </a>
