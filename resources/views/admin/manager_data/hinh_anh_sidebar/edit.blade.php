                ...
                <form action="#" method="POST" id="editForm" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="link" data-required="1" class="form-control" value="{{$hinhanhsidebar->Link}}"/> 
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <img class="responsive-img " src="{{ URL::asset($hinhanhsidebar->HinhAnh) }}" alt="ảnh" class="img-circle" width="150px" height="150px">
                                <br>
