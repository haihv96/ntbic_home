        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase"> Thêm tin tuyển dụng</span>
                </div>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="admin/tuyen-dung" id="form_sample_3" class="form-horizontal" method="POST" enctype="multipart/form-data">
                    <div class="form-body">
