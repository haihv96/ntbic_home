    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            ...
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{{url('admin/permissions/'.$permission->id)}}" method="POST" id="editForm" class="form-horizontal">
                    {{ method_field('PUT') }}
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="name" data-required="1" class="form-control" value="{{$permission->name}}" /> </div>
                        </div>
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                <button type="submit" class="btn green">Sửa</button>
                                <a class="btn default cancel" href="{{route('permissions.index')}}">Hủy</a>
                            </div>
                        </div>
                    </div>
                </form>
